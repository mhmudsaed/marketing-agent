...
export class MediaService extends BaseService {
  ...
  private isRemuxRequired(ffmpegConfig: SystemConfigFFmpegDto, { formatName, formatLongName }: VideoFormat): boolean {
    ...
    const required = name !== VideoContainer.Mp4 && !ffmpegConfig.acceptedContainers.includes(name);
    console.log(`[DEBUG] formatName: ${formatName}, name: ${name}, acceptedContainers: ${ffmpegConfig.acceptedContainers}, returning: ${required}`);
    return required;
  }
